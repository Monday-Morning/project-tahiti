...
function HallInfos() {
  return (
    <>
      <Head>
        {/* <!-- =============== Primary Meta Tags =============== --> */}
        <title>Hall Info | Monday Morning</title>
        <meta name='title' content='Hall-Info | Monday Morning' />
        <meta
          name='description'
        ...
        <meta
          name='keywords'
          content='Hall-Info,monday morning, mondaymorning, monday morning, mm, nit rkl, nit, nit rourkela, nitr, nitrkl, rkl, rourkela'
        />
        ...
        <meta
          property='og:url'
          content='https://mondaymorning.nitrkl.ac.in/Hall-Info'
        />
        <meta
          property='og:site_name'
          content='Monday Morning | The Student Media Body of NIT Rourkela, India'
        />
        <meta property='og:title' content='Hall-Info | Monday Morning' />
        <meta
