...
const EventPage = () => {
  return (
    <>
      <Head>
        {/* <!-- =============== Primary Meta Tags =============== --> */}
        <title>Event | Monday Morning</title>
        <meta name='title' content='Event | Monday Morning' />
        <meta
          name='description'
        ...
        <meta
          name='keywords'
          content='event, monday morning, mondaymorning, monday morning, mm, nit rkl, nit, nit rourkela, nitr, nitrkl, rkl, rourkela'
        />
        ...
        <meta
          property='og:url'
          content='https://mondaymorning.nitrkl.ac.in/event'
        />
        <meta
          property='og:site_name'
          content='Monday Morning | The Student Media Body of NIT Rourkela, India'
        />
        <meta property='og:title' content='Event | Monday Morning' />
        <meta
