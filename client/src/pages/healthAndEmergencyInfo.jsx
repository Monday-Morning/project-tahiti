...
function HealthAndEmergencyInfo() {
  return (
    <>
      <Head>
        {/* <!-- =============== Primary Meta Tags =============== --> */}
        <title>Health-and-Emergency-info | Monday Morning</title>
        <meta
          name='title'
          content='Health-and-Emergency-info | Monday Morning'
        />
        <meta
          name='description'
        ...
        <meta
          name='keywords'
          content='Health-and-Emergency-info,monday morning, mondaymorning, monday morning, mm, nit rkl, nit, nit rourkela, nitr, nitrkl, rkl, rourkela'
        />
        ...
        <meta
          property='og:url'
          content='https://mondaymorning.nitrkl.ac.in/Health-and-Emergency-info'
        />
        <meta
...
export default HealthAndEmergencyInfo;
