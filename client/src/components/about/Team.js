...
const Team = () => {
    ...
    return (
        <div className={classes.wrapper}>
            ...
            <Grid container  direction="row" justify="flex-start" alignItems="center" className={classes.batchWrapper}>
                {ABOUT.batches.map((batch,key) => (
                    <Grid item key={key}>
                        <div className={activeBatch == batch ? classes.active :classes.batch} onClick={() => selectBatch(batch)}>
