                ...
                <Grid item xs={12} md={7}>
                    <div className={classes.emailWrapper}>
                        ...
                        <Grid item key={key} className={classes.mail}>
                            ...
                            <a href={`mailto:${email.id}`} className={classes.mailid}>{email.id}</a>
                ...
                <Grid item xs={12} md={5}>
                    <div className={classes.ccWrapper}>
                        ...
                        <Grid item key={key} className={classes.ccs}>
                            <Typography variant='body1'>
                            <span className={classes.cc}>{cc.name} : {cc.number} </span>
                            <span className={classes.messageIcon}><i className="far fa-envelope" ></i></span>
                            </Typography>
                        </Grid>
                        ))}
                    </div>
                    ...
                    <div className={classes.locationWrapper}>
                        <Grid container justify='center'>
                            ...
                            <a href='https://goo.gl/maps/EKwq5J2x1djPHwVB9' target='_blank'>
                                <Typography variant='body2' className={classes.mapText}>See on map</Typography>
                            </a>
                            </Grid>
                        </Grid>
                    </div>
