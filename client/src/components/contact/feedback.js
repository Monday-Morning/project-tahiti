        ...
        <div className={classes.wrapper}>
            <Grid container className={classes.elementWrapper} spacing={4}>
                <Grid item xs={12} md={7}>
                    <Typography variant='h3' className={classes.title}>We’d love to hear from you</Typography>
                    <form onSubmit={handleSubmit}>
                        ...
                        <Grid container justify='flex-end' spacing={3} className={classes.buttonWrapper}>
                        <Grid item ><Button onClick={cancel} variant="contained" disabled={!enabled}>
                ...
                <Grid item xs={12} md={5}>
                    <div className={classes.imageWrapper}><img src={image} alt='Feedback' className={classes.image}/></div>
                </Grid>
            </Grid>
        </div>
    );
