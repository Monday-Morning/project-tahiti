...
export const PROJECT = Object.freeze({
  about:
    'Since 2006 when it started as a print newsletter, MM has come a long way. It has had many projects in this journey including website and app revamps. Read more about it here.',
  Projects: [
    {
